...
export const resourceDisplayName = 'Content Field Validation Rule';

export const resourcesDisplayName = 'Content Field Validation Rules';

export const resourceBaseRoute = 'content-field-content-validation-rules';
...
export const columns = [
    {
        dataField: 'content_field_content_validation_rules.content_field.name',
        text: 'Field',
        className: 'col-md-12 col-12',
    },
    {
        dataField: 'content_field_content_validation_rules.content_validation_rule.name',
...
export const schema = {
    ...
    content_validation_rule_id: {
        ...
        emptyOption: 'Please select a new Validation Rule to associate to this Field...',
        values: [],
